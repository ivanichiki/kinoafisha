...
<div className='slider'>
  ...
  <div style={state.Vrightbtn ? { display: 'block' } : { display: 'none' }} onClick={() => dispatch({ type: 'Videoscroll', value: 1300 })} className='rightButton'> <span className='stelka'> &rsaquo; </span> </div>

  {state.Vleftbtn && <div onClick={() => dispatch({ type: 'Videoscroll', value: -1300 })} className='rightButton left'> <span className='stelka'> &lsaquo; </span> </div>}
</div>
